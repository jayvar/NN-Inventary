...
ActiveRecord::Schema.define(version: 20150708040141) do
  ...
  add_index "computers", ["laboratory_id"], name: "index_computers_on_laboratory_id", using: :btree
  ...
  add_index "laboratories", ["employe_id"], name: "index_laboratories_on_employe_id", using: :btree
