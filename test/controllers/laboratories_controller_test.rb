...
class LaboratoriesControllerTest < ActionController::TestCase
  ...
  test "should create laboratory" do
    assert_difference('Laboratory.count') do
      post :create, laboratory: { aforo: @laboratory.aforo, description: @laboratory.description, employe_id: @laboratory.employe_id, name: @laboratory.name }
    end
  ...
  test "should update laboratory" do
    patch :update, id: @laboratory, laboratory: { aforo: @laboratory.aforo, description: @laboratory.description, employe_id: @laboratory.employe_id, name: @laboratory.name }
    assert_redirected_to laboratory_path(assigns(:laboratory))
  end
