...
class ComputersControllerTest < ActionController::TestCase
  ...
  test "should create computer" do
    assert_difference('Computer.count') do
      post :create, computer: { description: @computer.description, laboratory_id: @computer.laboratory_id, name: @computer.name, serie: @computer.serie }
    end
  ...
  test "should update computer" do
    patch :update, id: @computer, computer: { description: @computer.description, laboratory_id: @computer.laboratory_id, name: @computer.name, serie: @computer.serie }
    assert_redirected_to computer_path(assigns(:computer))
  end
